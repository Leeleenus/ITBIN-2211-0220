...
public class ViewUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 60, 837, 335));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Click on row to Delete User");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 410, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/6.png"))); // NOI18N
    ...
    try {
        ...
        while (rs.next()) {
            // Make sure the column indices in the rs.getString match your table structure
        ...
        JOptionPane.showMessageDialog(null, "Error casting table model: " + ex.getMessage());
    } catch (NullPointerException ex) {
        JOptionPane.showMessageDialog(null, "Error: jTable1 or its model is not properly initialized.");
    }
    ...
    if (index != -1) { // Check if a row is selected
        ...
        if (username.equals(usernameTable)) {
            ...
            int option = JOptionPane.showConfirmDialog(null, "Do you want to delete this user?", "Confirmation", JOptionPane.YES_NO_OPTION);
